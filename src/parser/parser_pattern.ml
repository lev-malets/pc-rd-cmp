    ...
    (module struct
      ...
      let pattern_poly_constrainted =
        ...
        & choice
            [
              with_loc
              & hlp2 Pat.constraint_ + pattern - ng - colon - ng
                + core_type_poly;
              pattern;
            ]
      ...
      let polyvariant =
        with_loc & (hlp2 Pat.variant + variant_tag + opt constructor_arguments)
      ...
      let pattern_atom =
        choice ~name:"pattern:atom"
          [
            ...
            with_loc
            & (hlp2 Pat.interval + character - ng - dot_dot - ng + character);
            number_range;
            with_loc
            & mapping (fun loc ->
      ...
      let primary =
        choice
          [
            with_loc & (hlp Pat.lazy_ - lazy' - ng + pattern_exception);
            pattern_exception;
          ]
